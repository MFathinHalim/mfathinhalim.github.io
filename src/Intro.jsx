      ...
      <article id='who' className='mb-8'>
        ...
        <div className='grid grid-cols-1 gap-6 lg:grid-cols-2'>
          ...
          <article className='p-3'>
            <p className='p-3 pt-0 text-justify text-gray-500 text-2xl' style={{ fontFamily: "Caveat" }}>
              Being a developer is really fun for me, because programming gives me the power to turn my imagination into reality and every project is a new opportunity to learn and grow. I believe that my experience can benefit others as well!
            </p>
            <img loading='lazy' draggable='false' data-aos='fade-down' className='mt-3 mx-auto w-full m-3 rounded-lg' style={{ height: "65%", objectFit: "cover" }} src='./f7-A-Fathin-pembuat-aplikasi-Kamus-Kata-Bahasa-Rejang.jpg' alt='M.Fathin Halim' />
          </article>
        </div>
      </article>
