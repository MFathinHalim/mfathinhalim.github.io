function Award(){
    const awards = [{
        ...
        img:["https://play-lh.googleusercontent.com/UgCNG2x18CiA6nu4TUHwP9b-QhH3FnlU3WP0812FMMpRmBs6YO5phTLZ9PM3Ab5Jd2o=w2560-h1440-rw","https://play-lh.googleusercontent.com/AleA5pJ6XfoXT1RtdvLw5U0oYccWrebhD5DNpFc7oTrcfPWxHvbZFmSGgKeJlS0Qtw=w2560-h1440-rw"]
    }];
    return (<>
...
>
  Award
        ...
        {awards.map(award => (
        <div key={award.name} className="grid grid-cols-1 gap-6 sm:grid-cols-2">
        ...
        <section className="p-3">
          <h6 className="text-2xl ease-in-out delay-150">
            {award.name}
          </h6>
