...
function Navbar() {
  ...
  const getLinkClassNames = (path) => {
    return currentPath === path
      ? "block py-2 px-3 text-white rounded-sm md:bg-transparent md:p-0 font-bold"
  ...
  return (
    <nav>
      <div
        className={`sticky flex flex-wrap items-center ${currentPath !== "/" && "my-10"}`}
      >
        <div className={`w-1/2 mr-0 w-full md:block md:w-auto`}>
          <ul className="font-medium flex  p-4 p-0 border border-gray-100 rounded-lg  flex-row space-x-8 rtl:space-x-reverse mt-0 border-0 bg-transparent">
            ...
            <li>
              <a href="/journey/" className={getLinkClassNames("/journey/")}>
                Journey
              </a>
            </li>
            <li>
              <a
                ...
                className={getLinkClassNames(
                  "https://discordapp.com/users/1156486226094870569",
                )}
              >
                Contact
              </a>
