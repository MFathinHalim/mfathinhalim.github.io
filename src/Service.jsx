        ...
        <>
            <div id="services" className="mb-8 " data-aos="zoom-in">
                <div className="p-3 mb-3">
                    ...
                    style={{ marginTop: 50, fontFamily: "sans-serif", fontWeight: "bold" }}
                    >
                    Service
                    </h1>
                    ...
                    quality website development services with attractive designs. Discuss your
                    needs with M.Fathin Halim through Discord or Email!
                    </p>
                    ...
                    <p>
                    We use Express-based NodeJS as the Backend and Bootstrap for styling on
                    the Frontend to create responsive and attractive websites.
                    </p>
                </div>
                <a
                    ...
                    style={{ animation: "glowing 5000ms infinite", background: "#5539cc" }}
                >
