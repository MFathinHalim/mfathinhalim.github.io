function Service() {
  return (
    <>
      <div
        id='services'
        className='relative px-3 py-4 md:py-20 md:px-8 rounded-xl shadow-lg bg-gray-800 mt-4 bg-opacity-80 bg-blend-overlay bg-center transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-2xl'
        style={{
