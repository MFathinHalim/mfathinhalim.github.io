function Service() {
  return (
    <>
      <div
        id='services'
        className='relative p-8 pb-8 rounded-xl shadow-lg bg-gray-800 mt-4 bg-opacity-80 bg-blend-overlay bg-center bg-fixed transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-2xl'
        style={{
        ...
        <div className='pb-6 text-center pt-8'>
          <h3 id="Name" className='text-3xl sm:text-4xl mt-6 text-white font-bold drop-shadow-lg'>Unlock Your Website</h3>
          <h4 className='text-1xl sm:text-4xl mt-4 text-gray-400 drop-shadow-lg font-light'>We create websites that take your dreams to the next level.</h4>
        </div>
        <div className='text-center pb-9'>
          <a href='https://discordapp.com/users/1156486226094870569' className='inline-block px-6 py-3 m-3 mt-0 text-lg font-semibold text-white bg-indigo-500 rounded-md hover:bg-indigo-600 transition-all duration-300 ease-in-out transform hover:scale-110 shadow-md'>
            <i className='fa-brands fa-discord' style={{ color: "white" }} /> Let's Build!
          </a>
          <a href='mailto:halimfathin7@gmail.com' className='hidden sm:inline-block px-6 py-3 m-3 ms-2 border-gray-500 border-2 mt-0 text-lg font-semibold rounded-md text-gray-100 bg-transparent hover:bg-white hover:text-black transition-all duration-300 ease-in-out transform hover:scale-110 shadow-md'>
