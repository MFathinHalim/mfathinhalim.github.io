function Service() {
  return (
    <>
      <div
        id='services'
        className='relative px-3 py-4 md:py-20 md:px-8 super-rounded shadow-lg bg-gray-800 mt-4 bg-opacity-80 bg-blend-overlay bg-center transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-2xl'
        style={{
        ...
        <div className='pb-5 text-center'>
          ...
          <a href='mailto:halimfathin7@gmail.com' className='hidden sm:inline-block px-6 py-3 my-0 mx-2 border-gray-500 border-2 mt-0 text-lg font-semibold rounded-md text-gray-100 bg-transparent hover:bg-white hover:text-black transition-all duration-300 ease-in-out transform hover:scale-110 shadow-md'>
